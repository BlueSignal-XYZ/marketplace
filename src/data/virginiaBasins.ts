 ...
 */
export function canTradeBetweenBasins(buyerBasinCode: string, sellerBasinCode: string): boolean {
 ...
 */
export function getExchangeRatio(buyerBasinCode: string, sellerBasinCode: string): number {
  if (buyerBasinCode === sellerBasinCode) {
    return 1.0;
  }
