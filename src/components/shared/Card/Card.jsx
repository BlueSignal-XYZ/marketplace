...
export const Card = styled.div`
  ...
  ${({ $featured }) =>
    ...
    css`
      ...
      background: linear-gradient(180deg, rgba(56, 189, 190, 0.03) 0%, rgba(255, 255, 255, 1) 100%);
      box-shadow:
  ...
  ${({ $warning }) =>
    ...
    css`
      ...
      background: linear-gradient(180deg, rgba(245, 158, 11, 0.03) 0%, rgba(255, 255, 255, 1) 100%);
    `}
