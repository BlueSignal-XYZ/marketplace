...
const HeaderWrapper = styled.header`
  ...
  background: ${(props) => (props.$scrolled ? 'rgba(15, 23, 42, 0.98)' : 'rgba(15, 23, 42, 0.9)')};
  backdrop-filter: blur(16px);
  -webkit-backdrop-filter: blur(16px);
  border-bottom: 1px solid
    ${(props) => (props.$scrolled ? 'rgba(255, 255, 255, 0.08)' : 'transparent')};
...
export default function SalesHeader({ onScrollToContact }) {
