  ...
  return (
    <FooterWrapper>
      <FooterContainer>
        <FooterTop>
          <BrandColumn>
            <LogoLink href="https://bluesignal.xyz" target="_blank" rel="noopener noreferrer">
              <img src={bluesignalLogo} alt="BlueSignal" />
            </LogoLink>
            <BrandTagline>
              Transform your water quality data into tradeable credits with professional-grade
              ...
              <>
                <NewsletterForm onSubmit={handleNewsletterSubmit}>
                  <NewsletterInput
                    ...
                    required
                  />
                  <NewsletterButton type="submit" disabled={formState.status === 'submitting'}>
        ...
        <FooterBottom>
          ...
          <LegalLinks>
            ...
            <LegalLink href="/warranty">Warranty Info</LegalLink>
