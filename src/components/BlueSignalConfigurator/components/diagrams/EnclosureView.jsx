  ...
  const getComponentsForProduct = (productId) => {
    const baseComponents = {
      ...
      piZero: {
        ...
        description:
          'Main controller with WiFi/BT. Runs sensor polling, data logging, and uplink coordination.',
      ...
      lteHat: {
        ...
        description:
          'Cellular modem for data uplink. GNSS for geolocation tagging of sensor readings.',
      ...
      ads1115: {
        ...
        name: 'ADS1115 ADC (×3)',
        description:
          '16-bit analog-to-digital converters for water quality sensors. I2C bus, addressable.',
          ...
          >
            ...
            >
              ...
              >
                ...
                <span style={{ fontSize: '7px', color: '#ef4444', textAlign: 'center' }}>
                  FAN
                  <br />
                  ↑OUT
                </span>
        ...
        <div style={{ flex: 1 }}>
          ...
          >
            ...
            <div style={{ fontSize: '11px', color: '#888', lineHeight: '2.2' }}>
              <div>
                <span style={{ color: '#3b82f6' }}>→</span> Cool air in via right louvers
              </div>
              <div>
                <span style={{ color: '#f97316' }}>▣</span> Heat generated in lower zone
              </div>
              <div>
                <span style={{ color: neonColor }}>⋮</span> Rises through perforated shelf
              </div>
              <div>
                <span style={{ color: '#ef4444' }}>↑</span> Exhausted via left wall fan
              </div>
            </div>
          </div>
        </div>
