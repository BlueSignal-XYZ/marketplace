    ...
    <svg viewBox="0 0 600 450" style={{ width: '100%', maxWidth: 600 }}>
      ...
      {isFloating ? (
        <>
          ...
          <path
            d="M0,220 Q75,210 150,220 T300,220 T450,220 T600,220 L600,230 Q525,240 450,230 T300,230 T150,230 T0,230 Z"
            fill="#38bdf8"
            opacity="0.2"
          />
          ...
          <text x="300" y="180" textAnchor="middle" fill="#e2e8f0" fontSize="10" fontWeight="600">
            ENCLOSURE
          </text>
          ...
          {hasUltrasonic && (
            <>
              ...
              <line
                ...
                strokeDasharray="4"
              />
              <text x="300" y="370" textAnchor="middle" fill="#f97316" fontSize="10">
                28kHz waves
              </text>
              {isXL && (
                <>
          ...
          <g transform="translate(180, 250)">
            ...
            <text x="20" y="35" textAnchor="middle" fill="#ffffff" fontSize="8" fontWeight="600">
              SENSORS
            </text>
          </g>
          ...
          <text x="300" y="445" textAnchor="middle" fill="#94a3b8" fontSize="10">
            ANCHOR
          </text>
        </>
      ) : (
        <>
          ...
          <path
            d="M300,280 L300,320 Q350,340 300,360 L300,450"
            stroke="#78716c"
            strokeWidth="3"
            fill="none"
          />
          ...
          <text x="150" y="160" textAnchor="middle" fill="#e2e8f0" fontSize="10" fontWeight="600">
            ENCLOSURE
          </text>
          ...
          {/* Cable to water */}
          <path
            d="M150,190 L150,250 Q150,300 200,320 L350,340"
            stroke="#475569"
            strokeWidth="4"
            fill="none"
          />
          ...
          {hasUltrasonic && (
            <>
              ...
              <line
                ...
                strokeDasharray="4"
              />
              <text x="360" y="440" textAnchor="middle" fill="#f97316" fontSize="10">
                28kHz waves
              </text>
            </>
          )}
          ...
          {product.power.type === 'AC' && (
            <>
              ...
              <text x="30" y="155" textAnchor="middle" fill="#fbbf24" fontSize="10">
                AC
              </text>
            </>
          )}
          ...
          {product.battery && (
            <g transform="translate(220, 140)">
              ...
              <text x="25" y="22" textAnchor="middle" fill="#ffffff" fontSize="8" fontWeight="600">
                BATTERY
              </text>
            </g>
          )}
