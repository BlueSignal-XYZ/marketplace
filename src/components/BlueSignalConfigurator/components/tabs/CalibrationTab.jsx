  ...
  <div>
    ...
    {Object.entries(CALIBRATION)
      .filter(([key]) => {
        ...
        if (
          key === 'dissolvedOxygen' &&
          !product.sensorList.some((s) => s.includes('Dissolved') || s.includes('DO'))
        )
          return false;
          ...
          >
            ...
            {cal.voltageRange && (
              <div>
                ...
                <p style={{ color: '#e2e8f0', fontSize: 13, margin: '4px 0 0' }}>
                  {cal.voltageRange}
                </p>
              </div>
            )}
            ...
            {cal.interval && (
              <div>
                ...
                <p style={{ color: '#4ade80', fontSize: 13, fontWeight: 600, margin: '4px 0 0' }}>
                  {cal.interval}
                </p>
              </div>
            )}
