...
const NPC_PRODUCT_DATA = {
  title: `Offset Pollution`, // REVIEW: Was "Eliminate Pollution" — credits offset, not eliminate
  description: `Enhance water quality and reduce pollution. Each purchase includes a tracking certificate with verified digital impact records.`,
  formTitle: `Nutrient Pollution Certificates`,
  formText: `Each credit offsets 1 pound of mixed nutrient pollutants in the watershed, supporting vital environmental conservation and restoration efforts.`,
};
