  ...
  return (
    <StyledDiv>
      ...
      <p className="stripe-confirm" style={{ textAlign: 'left' }}>
        <FaCheck />
        Purchase is accepted via Stripe.
      </p>
      <hr />

      <p className="info-text">
        Stripe will retain the card information, whereas we will retain the First and Last Name,
        Email Address, Quantity, Whether or not purchase is for a business, if so, what the business
        is named.
      </p>
      <p className="info-text">
        During presale, we hold 50% of the payment total. The other 50% will be processed upon the
        release of our initial supply.
      </p>
