    ...
    <FULL_PAGE_CONTAINER>
      ...
      <CARD_WRAPPER>
        ...
        {transitions((style, isPaying) =>
          !isPaying ? (
            <ProductDisplay
              supplyManagement={{ amount, setAmount }}
      ...
      <div className="features">
        <div className="features-section">
          ...
          <div className="features-section-paragraph">
            Enhance water quality and reduce pollution. Each purchase includes a tracking
            certificate with verified digital impact records.
          </div>
        </div>
        <div className="features-section">
          <FaCertificate />
          <div className="features-section-title">Nutrient Pollution Certificates</div>
          <div className="features-section-paragraph">
            Each credit offsets 1 pound of mixed nutrient pollutants in the watershed, supporting
            vital environmental conservation and restoration efforts.
          </div>
        </div>
      </div>
    </FULL_PAGE_CONTAINER>
