...
const SystemDiagram = () => (
  ...
  >
    ...
    <g>
      ...
      />
      {/* Enclosure label */}
      <text x="330" y="322" textAnchor="middle" fill={C.w(0.12)} className="label">
      ...
      <g>
        <rect
          ...
          height="235"
          rx="5"
          fill="url(#sd-boardGrad)"
          stroke={C.g(0.3)}
          strokeWidth="0.8"
        />
        {/* Board label */}
        <text x="330" y="75" textAnchor="middle" fill={C.g(0.25)} className="label-data">
          WQM-1 Rev 2.1
        </text>
        ...
        <rect
          ...
          strokeWidth="0.5"
        />
        <text x="148" y="94" textAnchor="middle" fill={C.r(0.4)} className="label-sm">
          VIN
        </text>
        ...
        <rect
          ...
          strokeWidth="0.5"
        />
        <text x="153" y="126" textAnchor="middle" fill={C.r(0.3)} className="label-sm">
          Power
        </text>
        ...
        <rect
          ...
          strokeWidth="0.5"
        />
        <text x="230" y="175" textAnchor="middle" fill={C.g(0.35)} className="label-sm">
          ADS1115
        </text>
        ...
        <rect
          ...
          strokeWidth="0.6"
        />
        <text x="338" y="170" textAnchor="middle" fill={C.w(0.3)} className="label-data">
          BCM2710A1
        </text>
        <text x="338" y="183" textAnchor="middle" fill={C.w(0.15)} className="label-sm">
          Quad A53
        </text>
        ...
        <rect
          ...
          strokeWidth="0.5"
        />
        <text x="455" y="126" textAnchor="middle" fill={C.b(0.35)} className="label-sm">
          GPS
        </text>
        ...
        <rect
          ...
          strokeWidth="0.5"
        />
        <text x="455" y="166" textAnchor="middle" fill={C.b(0.4)} className="label-sm">
          SX1262
        </text>

        {/* PH */}
        <circle cx="495" cy="230" r="9" fill="#0f1114" stroke={C.g(0.25)} strokeWidth="0.6" />
        <text x="495" y="233" textAnchor="middle" fill={C.g(0.3)} className="label-sm">
          PH
        </text>
        ...
        <rect
          ...
          strokeWidth="0.4"
        />
        <text x="153" y="221" textAnchor="middle" fill={C.w(0.18)} className="label-sm">
          GPIO
        </text>
    ...
    <g>
      ...
      <text x="620" y="17" textAnchor="middle" fill={C.w(0.22)} className="label-sm">
        915 MHz
      </text>
      <text x="620" y="100" textAnchor="middle" fill={C.w(0.2)} className="label-sm">
        LoRa Antenna
      </text>
    </g>
    ...
    <g>
      <rect
        ...
        strokeWidth="0.8"
      />
      <text x="608" y="175" fill={C.b(0.25)} className="label-sm">
        GPS
      </text>
    </g>
    ...
    <g>
      ...
      <text x="50" y="428" textAnchor="middle" fill={C.r(0.5)} className="label-data">
        9–24V
      </text>
      <text x="50" y="452" textAnchor="middle" fill={C.w(0.22)} className="label-sm">
        DC Power
      </text>
    </g>
    ...
    <g>
      ...
      <text x="610" y="408" textAnchor="middle" fill={C.g(0.55)} className="label-data">
        pH
      </text>
      <text x="610" y="420" textAnchor="middle" fill={C.w(0.2)} className="label-sm">
        0–14
      </text>
      <text x="610" y="492" textAnchor="middle" fill={C.w(0.2)} className="label-sm">
        pH Probe
      </text>
    </g>
    ...
    <g>
      ...
      <rect
        ...
        strokeWidth="0.8"
      />
      <text x="190" y="398" textAnchor="middle" fill={C.b(0.5)} className="label-data">
        TDS
      </text>
      ...
      <rect
        ...
        strokeWidth="0.8"
      />
      <text x="220" y="398" textAnchor="middle" fill={C.b(0.5)} className="label-data">
        ORP
      </text>
      ...
      <rect
        ...
        strokeWidth="0.8"
      />
      <text x="250" y="398" textAnchor="middle" fill={C.a(0.5)} className="label-data">
        Turb
      </text>
      ...
      <text x="220" y="468" textAnchor="middle" fill={C.w(0.2)} className="label-sm">
        Sensor Array
      </text>
    </g>
    ...
    <g>
      ...
      <rect
        ...
        strokeWidth="0.8"
      />
      <text x="340" y="398" textAnchor="middle" fill={C.b(0.4)} className="label-data">
        I²C
      </text>
      <text x="340" y="410" textAnchor="middle" fill={C.w(0.18)} className="label-sm">
        3.3V
      </text>
      {/* Connector pins */}
      {[0, 1, 2, 3].map((i) => (
      ...
      <text x="340" y="428" textAnchor="middle" fill={C.w(0.2)} className="label-sm">
        Expansion
      </text>
    </g>
    ...
    <g>
      ...
      <text x="460" y="434" textAnchor="middle" fill={C.a(0.5)} className="label-data">
        Doser
      </text>
      <text x="460" y="448" textAnchor="middle" fill={C.w(0.2)} className="label-sm">
        Relay Out
      </text>
      <text x="460" y="460" textAnchor="middle" fill={C.w(0.15)} className="label-sm">
        10A · 250VAC
      </text>
    </g>
    ...
    <g>
      {[
        ...
        <g key={label}>
          ...
          <text x={cx + 10} y="543" fill={C.w(0.35)} className="label-sm">
            {label}
          </text>
        </g>
      ))}
