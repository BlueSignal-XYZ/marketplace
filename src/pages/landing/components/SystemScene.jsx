...
const SystemScene = () => (
  ...
  >
    ...
    <g>
      ...
      />
      {/* Label */}
      <text x="130" y="358" textAnchor="middle" fill="rgba(255,255,255,0.3)" className="label">
    ...
    <g>
      ...
      />
      <text x="340" y="238" textAnchor="middle" fill="rgba(255,255,255,0.2)" className="label-sm">
        H&#x2082;O Supply
      </text>
    </g>
    ...
    <g>
      ...
      <g clipPath="url(#tankClip)">
        ...
        <g className="wave-surface">
          <path
            d="M460 200 Q500 192 540 200 Q580 208 620 200 Q660 192 700 200 Q740 208 780 200"
            stroke="#2d8cf0"
            strokeWidth="1.5"
            fill="none"
            opacity="0.4"
      ...
      <text x="738" y="213" fill="rgba(255,255,255,0.25)" className="label-sm">
        72%
      </text>
    </g>
    ...
    <g>
      ...
      <text x="594" y="126" fill="#34d399" className="label-data">
        pH 7.2
      </text>
      <text x="594" y="136" fill="#5badff" className="label-data">
        420 ppm
      </text>
      {/* LEDs */}
      ...
      {/* Label */}
      <text x="625" y="96" textAnchor="middle" fill="rgba(255,255,255,0.3)" className="label">
        BlueSignal WQM-1
      </text>
    </g>
    ...
    <g>
      <rect
        ...
        strokeWidth="1"
      />
      <text x="545" y="309" textAnchor="middle" fill="rgba(168,85,247,0.6)" className="label-sm">
        Ultrasonic Transducer
      </text>
      {/* Sonar rings */}
      ...
      <text x="545" y="385" textAnchor="middle" fill="rgba(255,255,255,0.2)" className="label-sm">
        Anti-Fouling
      </text>
    </g>
    ...
    <g>
      ...
      <text x="910" y="302" fill="rgba(255,255,255,0.25)" className="label-sm">
        94%
      </text>
      <text x="880" y="338" textAnchor="middle" fill="rgba(255,255,255,0.3)" className="label">
        DAB Mini
      </text>
    </g>
    ...
    <g>
      ...
      <path
        d="M670 120 L760 80 L1060 80 L1060 130"
        stroke="#2d8cf0"
        strokeWidth="1.5"
      ...
      {/* Signal arcs */}
      <path
        d="M748 42 Q760 32 772 42"
        fill="none"
        stroke="rgba(45,140,240,0.3)"
        strokeWidth="0.8"
      />
      <path
        d="M742 36 Q760 22 778 36"
        fill="none"
        stroke="rgba(45,140,240,0.2)"
        strokeWidth="0.8"
      />
      <text x="860" y="70" textAnchor="middle" fill="rgba(255,255,255,0.2)" className="label-sm">
        LoRaWAN &middot; Cayenne LPP &middot; Encrypted
      </text>
    </g>
    ...
    <g>
      ...
      <g clipPath="url(#dashClip)">
        ...
        <text x="1090" y="118" fill="rgba(255,255,255,0.6)" className="label-title">
          BlueSignal Cloud
        </text>
        <text x="1240" y="118" fill="rgba(255,255,255,0.25)" className="label-sm">
          3 devices online
        </text>
        {/* Sparkline charts */}
        {/* pH chart (green) */}
        <polyline
          points="1075,155 1095,150 1115,158 1135,148 1155,153 1175,146 1195,152"
          fill="none"
          stroke="#34d399"
          strokeWidth="1.2"
          opacity="0.7"
        />
        <text x="1075" y="170" fill="rgba(255,255,255,0.2)" className="label-sm">
          pH
        </text>
        {/* TDS chart (blue) */}
        <polyline
          points="1075,195 1095,190 1115,200 1135,188 1155,195 1175,192 1195,198"
          fill="none"
          stroke="#2d8cf0"
          strokeWidth="1.2"
          opacity="0.7"
        />
        <text x="1075" y="210" fill="rgba(255,255,255,0.2)" className="label-sm">
          TDS
        </text>
        {/* Turbidity chart (amber) */}
        <polyline
          points="1075,235 1095,230 1115,238 1135,228 1155,233 1175,240 1195,235"
          fill="none"
          stroke="#fbbf24"
          strokeWidth="1.2"
          opacity="0.7"
        />
        <text x="1075" y="250" fill="rgba(255,255,255,0.2)" className="label-sm">
          Turb
        </text>
        ...
        <text x="1242" y="156" fill="rgba(255,255,255,0.4)" className="label-sm">
          Tank-01 Active
        </text>
        <circle cx="1232" cy="173" r="3" fill="#34d399" />
        <text x="1242" y="176" fill="rgba(255,255,255,0.4)" className="label-sm">
          Pond-NE Active
        </text>
        <circle cx="1232" cy="193" r="3" fill="#fbbf24" className="pulse-dot" />
        <text x="1242" y="196" fill="rgba(255,255,255,0.4)" className="label-sm">
          Well-03 Alert
        </text>
        {/* Status badge */}
        <rect x="1230" y="220" width="88" height="20" rx="4" fill="rgba(52,211,153,0.1)" />
        <text x="1274" y="234" textAnchor="middle" fill="#34d399" className="label-sm">
          ALL NORMAL
        </text>
      </g>
    </g>
    ...
    <g>
      ...
      {/* Alert text */}
      <text x="1160" y="360" fill="rgba(255,255,255,0.6)" className="label-title">
        pH drift detected
      </text>
      <text x="1160" y="378" fill="rgba(255,255,255,0.25)" className="label-sm">
        Well-03 &middot; 6.2&#x2192;5.8 &middot; 3m ago
      </text>
    </g>
  </SceneSvg>
);
