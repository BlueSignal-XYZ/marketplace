...
const WiringDiagram = () => (
  ...
  >
    ...
    <g>
      ...
      {/* ── Board label ── */}
      <text x="275" y="67" textAnchor="middle" fill={C.g(0.3)} className="label">
        WQM-1 Rev 2.1
      </text>
      ...
      <g>
        ...
        {/* Labels */}
        <text x="66" y="46" textAnchor="middle" fill={C.r(0.55)} className="label-data">
          VIN
        </text>
        <text x="88" y="46" textAnchor="middle" fill={C.w(0.3)} className="label-data">
          GND
        </text>
        {/* Down arrows */}
        <path
          d="M66 30 L66 36 M63 34 L66 37 L69 34"
          stroke={C.r(0.4)}
          strokeWidth="0.8"
          fill="none"
        />
        <path
          d="M88 30 L88 36 M85 34 L88 37 L91 34"
          stroke={C.w(0.25)}
          strokeWidth="0.8"
          fill="none"
        />
      ...
      ════════════════════════════════════════════════════ */}
      <g>
        <text x="310" y="44" textAnchor="middle" fill={C.a(0.25)} className="label-sm">
          10A · 250VAC
        </text>
        {[0, 1, 2, 3].map((i) => {
          const bx = 155 + i * 85;
          return (
            <g key={`rt-${i}`}>
              ...
              <text
                ...
                className="label-pin"
              >{`NC${i + 1}`}</text>
              <text x={bx + 37} y="56" textAnchor="middle" fill={C.w(0.15)} className="label-pin">
                COM
              </text>
              <text
                x={bx + 59}
        ...
        {[0, 1, 2, 3].map((i) => {
          ...
          return (
            <g key={`ri-${i}`}>
              ...
              >{`CH${i + 1}`}</text>
              <text x={cx} y="115" textAnchor="middle" fill={C.w(0.18)} className="label-sm">
                Relay
              </text>
              {/* Trace IC → terminal */}
              <line
      ...
      <g>
        <rect
          ...
          strokeWidth="0.6"
        />
        <text x="86" y="108" textAnchor="middle" fill={C.r(0.4)} className="label-data">
          Power Reg
        </text>
        <text x="86" y="120" textAnchor="middle" fill={C.w(0.2)} className="label-sm">
          5V / 3.3V
        </text>
        {/* Capacitors */}
        <rect
      ...
      <g>
        ...
        <text x="64" y="161" fill={C.w(0.25)} className="label-sm">
          PWR
        </text>
        {/* STA1–STA4 */}
        {[
          ...
          <g key={label}>
            ...
            />
            <text x="64" y={cy + 3} fill={C.w(0.2)} className="label-sm">
              {label}
            </text>
          </g>
        ))}
      ...
      <g>
        <rect
          ...
          strokeWidth="0.5"
        />
        <text x="137" y="172" textAnchor="middle" fill={C.w(0.1)} className="label-pin">
          D17
        </text>
      </g>
      ...
      <g>
        <rect
          ...
          strokeWidth="0.8"
        />
        <text x="198" y="225" textAnchor="middle" fill={C.g(0.5)} className="label-title">
          ADS1115
        </text>
        <text x="198" y="240" textAnchor="middle" fill={C.w(0.22)} className="label-sm">
          16-bit · 4ch
        </text>
        {/* Trace ADC → Processor */}
        <path
          d="M250 228 L275 228 L275 225 L290 225"
          stroke={C.w(0.06)}
          strokeWidth="0.6"
          strokeDasharray="2 4"
        />
      ...
      <g>
        ...
        />
        {/* Labels */}
        <text x="350" y="224" textAnchor="middle" fill={C.w(0.4)} className="label-title">
          BCM2710A1
        </text>
        <text x="350" y="238" textAnchor="middle" fill={C.w(0.22)} className="label-sm">
          Quad A53
        </text>
        {/* Indicator LEDs */}
      ...
      <g>
        <rect
          ...
          strokeWidth="0.6"
        />
        <text x="462" y="112" textAnchor="middle" fill={C.b(0.45)} className="label-data">
          GPS
        </text>
        <text x="462" y="124" textAnchor="middle" fill={C.w(0.18)} className="label-sm">
          u.FL
        </text>
        {/* Trace to SMA */}
        <path
          d="M495 110 L510 110 L515 110"
          stroke={C.b(0.2)}
          strokeWidth="0.6"
          strokeDasharray="2 3"
        />
      ...
      <g>
        <rect
          ...
          strokeWidth="0.8"
        />
        <text x="462" y="168" textAnchor="middle" fill={C.b(0.5)} className="label-data">
          SX1262
        </text>
        <text x="462" y="181" textAnchor="middle" fill={C.w(0.22)} className="label-sm">
          LoRa
        </text>
        {/* Trace to SMA */}
        <path
          d="M495 167 L510 167 L515 167"
          stroke={C.b(0.3)}
          strokeWidth="1"
          strokeDasharray="3 3"
          className="data-flow"
      ...
      <g>
        ...
        <text x="500" y="350" textAnchor="middle" fill={C.w(0.25)} className="label-sm">
          PH
        </text>
        <text x="500" y="361" textAnchor="middle" fill={C.g(0.3)} className="label-sm">
          BNC
        </text>
        {/* Trace BNC → ADC */}
        <path
          d="M487 330 L440 330 L440 250 L250 250"
          stroke={C.g(0.1)}
          strokeWidth="0.6"
          strokeDasharray="2 4"
        />
      ...
      <g>
        <rect
          ...
          strokeWidth="0.5"
        />
        <text x="100" y="282" textAnchor="middle" fill={C.w(0.25)} className="label-sm">
          GPIO Header
        </text>
      ...
      <g>
        ...
        {/* Pin labels */}
        {['SDA', 'SCL', 'GND', 'V+', 'GND', '3V3', '1W', 'OUT', 'IN', 'OUT', 'IN', '5V'].map(
          (label, i) => (
            <text
              key={`hl-${i}`}
              x={68 + i * 32}
      ...
      <path
        d="M350 265 L350 280 L290 280 L290 122"
        stroke={C.a(0.07)}
        strokeWidth="0.5"
        strokeDasharray="2 4"
      />
      ...
      <g>
        <rect
          ...
          strokeWidth="0.8"
        />
        <text x="526" y="128" textAnchor="middle" fill={C.b(0.35)} className="label-sm">
          SMA
        </text>
      </g>
      ...
      <g>
        <rect
          ...
          strokeWidth="0.8"
        />
        <text x="526" y="184" textAnchor="middle" fill={C.b(0.35)} className="label-sm">
          SMA
        </text>
    ...
    <g>
      {[
        ...
        <g key={label}>
          ...
          <text x={cx + 10} y="465" fill={C.w(0.35)} className="label-sm">
            {label}
          </text>
        </g>
      ))}
