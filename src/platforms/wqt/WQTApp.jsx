...
const TradingProgramDetailPage = lazyWithRetry(
  () => import('../../wqt/pages/TradingProgramDetailPage')
);
const CreditPortfolioPage = lazyWithRetry(() => import('../../wqt/pages/CreditPortfolioPage'));
const CreateListingPage = lazyWithRetry(
  () => import('../../components/elements/marketplace/CreateListingPage')
);
const TransactionPage = lazyWithRetry(
  () => import('../../components/elements/marketplace/TransactionPage')
);
const VerificationUI = lazyWithRetry(
  () => import('../../components/elements/contractUI/VerificationUI')
);
const BuyerDashboard = lazyWithRetry(() => import('../../components/dashboards/BuyerDashboard'));
const SellerDashboard_Role = lazyWithRetry(
            ...
            <WQTShell user={user} isAuthLanding={isAuthLanding}>
              <Suspense fallback={<LoadingFallback />}>
                <Routes>
                  <Route
                    path="/"
                    element={<MarketplaceLanding user={user} authLoading={authLoading} />}
                  />
